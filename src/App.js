...
const AddRole = React.lazy(() => import('./pages/adminDashboard/AddRole'));
const UpdateRole = React.lazy(() => import('./pages/adminDashboard/UpdateRole'));
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path='/courts' element={<Suspense fallback={<Loading />} ><ExploreFields /></Suspense>} />
        ...
        <Route path='/addrole' element={<Suspense fallback={<Loading />} ><AddRole /></Suspense>} />
        <Route path='/updaterole/:id' element={<Suspense fallback={<Loading />} ><UpdateRole/></Suspense>} />
        ...
        <Route path='/countries' element={<Suspense fallback={<Loading />} ><Countries /></Suspense>} />
        <Route path='/addcountry' element={<Suspense fallback={<Loading />} ><AddCountry /></Suspense>} />
        <Route path='/updatecountry/:id' element={<Suspense fallback={<Loading />} ><UpdateCountry/></Suspense>} />
