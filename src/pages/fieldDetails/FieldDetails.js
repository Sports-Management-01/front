                                ...
                                <div className="room__details__facilities">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6">
                                            <ul>
                                                <li><span className="icon_check"></span> Takami Bridal Attire</li>
                                                <li><span className="icon_check"></span> Esthetic Salon</li>
                                                <li><span className="icon_check"></span> Multilingual staff</li>
                                                <li><span className="icon_check"></span> Dry cleaning and laundry</li>
                                                <li><span className="icon_check"></span> Credit cards accepted</li>
                                            </ul>
                                        </div>
                                        <div className="col-lg-6">
                                            <ul>
                                                <li><span className="icon_check"></span> Rent-a-car</li>
                                                <li><span className="icon_check"></span> Reservation & confirmation</li>
                                                <li><span className="icon_check"></span> Babysitter upon request</li>
                                                <li><span className="icon_check"></span> 24-hour currency exchange</li>
                                                <li><span className="icon_check"></span> 24-hour Manager on Duty</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
