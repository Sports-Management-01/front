                       ...
                       <div className="col-12 p-3 mb-4 bottom-border">
                        {/* blue area info */}
                          ...
                          <div className=" mb-3 person-avatar">
                            <div>
                            <label htmlFor="icon" className="mx-auto my-2 d-block " style={{width:150}}>
                                <img name="icon" value={category?.icon} src={category?.icon} className="d-block mx-auto rounded-circle w-100" width={150} alt="image"/>
                            ...
                            <div className="mb-3 mt-5">
                                ...
                                <input onChange={handleOnChange}  defaultValue={category?.name}  name="name" type="text" id="name" className="form-control"/>
                            </div>
                            <div className="mb-3">
                                <label htmlFor="email" className="mb-2">
                                    <small>Status <span className="text-danger">*</span>
                                    </small>
                                </label>
                                <select id="inputState" className="form-control" name="isActive"
                          onChange={handleOnChange} value={category.isActive}>
